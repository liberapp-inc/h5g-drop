...
var StartMessage = (function (_super) {
    ...
    function StartMessage() {
        ...
        _this.text = [];
        _this.text[0] = Util.newTextField("ボールを操作して障害物を避けろ！", Util.width / 20, 0xf0c000, 0.5, 0.4, true);
        _this.text[1] = Util.newTextField("← → ボタンで左右に移動", Util.width / 28, 0xf0c000, 0.5, 0.5, true);
